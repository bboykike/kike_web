                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Nombre*</label>
                                <input class="form-control" type="text" name="nombre" id="nombre" value="Enrique"
                                    required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="apellido" id="apellido" value="Koyoc"
                                    required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="direccion" id="direccion" value="calle 11"
                                    required>
                            </div>
                        </div>
                        <div class="col-md-6">
